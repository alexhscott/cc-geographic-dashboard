...
function openModal() {
  ...
  selectors.forEach(id => {
    ...
    csvHeaders.forEach((h, i) => {
      ...
      if (id === 'map-tracker' && (hl === 'current placement: record id' || hl === 'record id' || hl === 'client id' || hl === 'id' || hl === 'cci number' || hl === 'account number' || hl === 'tracker' || hl.includes('record id') || hl.includes('client id') || hl.includes('tracker #'))) opt.selected = true;
